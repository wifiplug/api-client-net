...
namespace WifiPlug.Api.Schema
{
    ...
    /// </summary>
    [Obsolete("Use DeviceFramework.Service")]
    public static class Services
    {
        /// <summary>
        /// An outlet.
        /// </summary>
        [Obsolete("Use DeviceFramework.Service.Outlet")]
        public static readonly Guid Outlet = new Guid("1ea7e8ab-5981-4d9d-8343-3deae13b4fff");

        /// <summary>
        /// A switch.
        /// </summary>
        [Obsolete("Use DeviceFramework.Service.Switch")]
        ...
        /// </summary>
        [Obsolete("Use DeviceFramework.Service.Metering")]
